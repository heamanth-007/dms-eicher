export const Navbar: React.FC = () => {
  return (
    <header className="h-[70px] bg-gradient-to-r from-[#184edb] to-[#0d287a] border-b border-white/10 flex items-center justify-between px-8 w-full box-border font-sans text-white">
